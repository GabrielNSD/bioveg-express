...
const testData = {
  ...
  p004: { name: "Cenoura", image: "https://i.postimg.cc/vH8mYzyX/cenoura.jpg" },
  p005: {
    name: "Beringela",
    image:
  ...
  p008: { name: "Tomate", image: "https://i.postimg.cc/DZWqMTjJ/tomate.jpg" },
  p009: {
    name: "Alface",
    image:
...
const Pequena = (props) => {
  ...
  const finishHanlder = () => {
    pedidosActions.postarPedido(name, phone, orderType, "pequena");
